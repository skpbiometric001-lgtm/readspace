...
async function seedDatabase() {
  ...
  if (seatCount === 0) {
    await Seat.insertMany(generateSeats(settings.acPrice, settings.nonAcPrice, settings.acSeatFrom, settings.acSeatTo, settings.nonAcSeatFrom, settings.nonAcSeatTo));
